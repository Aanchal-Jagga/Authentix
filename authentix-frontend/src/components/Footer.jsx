...
const footerLinks = {
  Product: [
    { label: 'Image Verification', path: '/image-verification' },
    { label: 'Gaze Detection', path: '/gaze-detection' },
    { label: 'Text Verification', path: '/text-verification' },
  ],
  Company: [
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-500 leading-relaxed max-w-xs">
              AI-powered truth detection platform. Verifying authenticity in the digital age.
            </p>
          </div>
