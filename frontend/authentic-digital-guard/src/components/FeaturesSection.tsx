...
import { ImageIcon, Video, Mic2, Eye, MonitorSmartphone, Globe } from 'lucide-react';
...
const features = [
  ...
  { icon: Video, title: 'Deepfake Video Detection', desc: 'Analyze frames and detect manipulated faces using temporal consistency checks.' },
  { icon: Mic2, title: 'Voice Clone Detection', desc: 'Identify synthetic speech generated by AI models through spectral analysis.' },
